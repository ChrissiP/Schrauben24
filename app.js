...
mongoose.connect('mongodb+srv://chrissi:passw@cluster0.ymou45g.mongodb.net/Schrauben24?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
.then(() => {
